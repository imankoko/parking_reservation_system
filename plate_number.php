...
<body style="text-align: center; font-family: 'Segoe UI', sans-serif; background: #f4f4f4; margin: 0;">
    ...
    <div style="margin-top: 50px; padding: 20px;">
        ...
        <div style="background: #333; color: #fff; padding: 40px; border-radius: 15px; display: inline-block; border: 4px solid #FFD700; box-shadow: 0 10px 20px rgba(0,0,0,0.2);">
            <p style="font-size: 0.9em; color: #FFD700; letter-spacing: 2px; margin-bottom: 10px; font-weight: bold;">CURRENT OCCUPANT</p>
            
            <h1 style="font-size: 3.5em; margin: 0; letter-spacing: 5px; font-family: monospace;">
            ...
            <a href="tel:<?php echo $data['phone_number']; ?>" style="font-size: 2rem; color: #FFD700; text-decoration: none; font-weight: bold; display: block; margin-top: 10px;">
